...
> **Spec home**: This file is the canonical home of the `db-schema` capability. An identical copy lives in `../change-001-foundation/specs/db-schema/spec.md` for review-time proximity; both will archive together when both changes are merged.
